    ...
    <div className="max-w-screen-xl mx-auto px-4 relative pt-12">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-gray-400  max-w-3xl mx-auto">
          At Digital Builders, we combine technical expertise with creative
          thinking to deliver tailored solutions that help your business thrive.
          Whether you need a sleek website, a powerful marketing campaign, or an
          unforgettable event, we’ve got you covered.
        </p>
      </div>
    </div>
  );
